...
typedef mlx_texture_t	t_mlx_tex;
...
void		set_grb(t_data *data, int direction,
				char **splited, t_free **collector);
...
void		check_infos_avalable(int *infos_presence,
				int bef, t_free **collector);
